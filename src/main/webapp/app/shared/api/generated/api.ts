...
export const AccountResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getAccountUsingGET(name?: string, options?: any): AxiosPromise<AdminUserDTO> {
...
export const ArticleResourceApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    getArticleUsingGET: async (pmid: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
      // verify required parameter 'pmid' is not null or undefined
      assertParamExists('getArticleUsingGET', 'pmid', pmid);
      const localVarPath = `/api/articles/{pmid}`.replace(`{${'pmid'}}`, encodeURIComponent(String(pmid)));
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
      let baseOptions;
      if (configuration) {
...
export const ArticleResourceApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async getArticleUsingGET(
      pmid: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Article>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.getArticleUsingGET(pmid, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
  };
};
...
export const ArticleResourceApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    getArticleUsingGET(pmid: string, options?: any): AxiosPromise<Article> {
      return localVarFp.getArticleUsingGET(pmid, options).then(request => request(axios, basePath));
    },
  };
};
...
export class ArticleResourceApi extends BaseAPI {
   ...
   */
  public getArticleUsingGET(pmid: string, options?: AxiosRequestConfig) {
    return ArticleResourceApiFp(this.configuration)
      .getArticleUsingGET(pmid, options)
      .then(request => request(this.axios, this.basePath));
  }
}
...
export const UserResourceApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async getAllUsersUsingGET(
      ...
      sort?: Array<string>,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<AdminUserDTO>>> {
